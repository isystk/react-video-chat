...
/** Presenter Component */
const HtmlSkeletonPresenter: FC<PresenterProps> = ({ main, title, description,isMenuOpen, setMenuOpen, children, ...props }) => (
  <>
    <Head>
      {/* タイトル */}
      <title>{title}</title>
...
/** Container Component */
const HtmlSkeletonContainer: React.FC<ContainerProps<HtmlSkeletonProps, PresenterProps>> = ({
  presenter,
  children,
  ...props
}) => {
  ...
  return presenter({ main, title, description, isMenuOpen, setMenuOpen, children, ...props })
}
